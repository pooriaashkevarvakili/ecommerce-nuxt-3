<template>
    <div class="flex flex-wrap text-center flex-col">
        <div class="mt-2 iran-sans">
            تماس با ما
        </div>
        <div class="flex iran-sans  justify-center mt-2">

            <div class="mr-1">آدرس</div>
        ...
        <div class="flex justify-center mt-2">
            ...
            <div class="mr-1 iran-sans">پشتیبانی</div>
        </div>
        <div class="mt-2">
